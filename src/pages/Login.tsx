...
const Login = React.memo(() => {
  const [loginorregistration, setloginorregistration] =
    useState<boolean>(false); // выбор нужной формы (логин или регистрация)
      ...
      <form className="body">
        ...
        <div className="pass">
          ...
          <Input
            ...
            type="password"
            value={password.str}
            onChange={password.ChangeState}
            placeholder="Введите пароль"
          />
        </div>
        {loginorregistration && (
          <div className="pass">
            {repeatpassword.blur && password.blur && matchPasses.error && (
              <div>Пароли не совпадают</div>
            )}
            <Input
              value={repeatpassword.str}
              onBlur={repeatpassword.OnBlur}
              onChange={repeatpassword.ChangeState}
              name="repeatpassword"
              type="password"
        ...
        {loginorregistration ? (
          <button type="submit" disabled={disabled} className="enter">
            Регистрация
          </button>
        ) : (
